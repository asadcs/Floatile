...
public sealed class ArenaState : MonoBehaviour
{
    ...
    // Spawn bounds: visible area + spawnMargin — used by NPCs and spawner.
    ...
    public static float VisibleHalfW { get; private set; } = 12.5f;
    public static float VisibleHalfH { get; private set; } = 7.0f;
    public static float VisibleMinX => -VisibleHalfW;
    public static float VisibleMaxX =>  VisibleHalfW;
    public static float VisibleMinY => -VisibleHalfH;
    public static float VisibleMaxY =>  VisibleHalfH;
    ...
    public static void SetVisibleBounds(float halfW, float halfH) { VisibleHalfW = halfW; VisibleHalfH = halfH; }
